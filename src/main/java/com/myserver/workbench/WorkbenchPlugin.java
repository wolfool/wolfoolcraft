...
public class WorkbenchPlugin extends JavaPlugin {
    ...
    private com.myserver.workbench.integration.CraftEngineBridge craftEngine;
    private com.myserver.workbench.integration.SkillBridge skills;
    ...
    public void onEnable() {
        ...
        craftEngine = new com.myserver.workbench.integration.CraftEngineBridge(this);
        skills = com.myserver.workbench.integration.SkillBridge.create(this);
        ...
        getServer().getPluginManager().registerEvents(
                new com.myserver.workbench.installation.FurnitureListener(
        ...
        if (craftEngine.isAvailable()) {
            getServer().getPluginManager().registerEvents(
                    new com.myserver.workbench.integration.CraftEngineReloadListener(
                            recipeManager, craftEngine), this);
        }
        getServer().getPluginManager().registerEvents(new com.myserver.workbench.gui.AdminEncyclopediaListener(recipeManager, craftEngine), this);
        
        WorkbenchCommand cmd = new WorkbenchCommand(this, craftingManager, recipeManager, databaseManager, skills, craftEngine);
        ...
        new com.myserver.workbench.installation.InstallationTask(installationManager)
